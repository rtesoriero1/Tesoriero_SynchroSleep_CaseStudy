...
public class NightService {
	...
	public void addNight(Night night) {
		...
		//This is used to get a specific night, used for calculating recommended Bed Time
	...
	//This is the logic for how the recommended Bed Time is calculated. It takes into account traits from profile, and the wake up time from Night
	public String nightCalc(Profile profile, Night night, String wakeUp) {
		...
		//The variables of gender and age from the profile are used to calculate the total sleep required per night in minutes
		if (Gender == "Female") {
